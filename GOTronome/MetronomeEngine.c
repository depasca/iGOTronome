...
//            printf("bar, beat, is silent, silentbar cnt, numSilentbars: %d, %d, %d, %d, %d\n", gCurrentBar, gCurrentBeat, gIsSilent, gSilentBarCounter, gNumSilentBars);
            
        }
        
        // Generate click at start of beat
        if (!gIsSilent && beatOffset < kClickDuration) {
